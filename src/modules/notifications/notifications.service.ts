...
export class NotificationsService {
  ...
  async sendNotification(options: {
    ...
    try {
      ...
      // Support static notification_text as direct message
      let text: string;
      let subject = '';
      let template: NotificationTemplate;
      if (typeof variables.notification_text === 'string') {
        text = variables.notification_text;
        // Fallback minimal template for channel logic
        template = {
          type,
          subject: '',
          text,
